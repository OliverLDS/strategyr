...
# Ladder bounce is a price-path rule. For this example, skip yield indices and
...
ladder_bounce_mining_res <- strategyr::mine_strategy_asset_years(
  market_data_list = asset_market_data,
  strategy_fun = strategyr::strat_ladder_bounce_tgt_pos,
...
print(ladder_bounce_mining_res$seed_params[, .(
  seed_asset,
  rank,
  cycle_N,
  span,
...
print(ladder_bounce_mining_res$candidate_params)

asset_year_res <- ladder_bounce_mining_res$asset_year_results
