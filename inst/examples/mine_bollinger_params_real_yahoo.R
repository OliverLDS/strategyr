...
# Bollinger reversion is a price-path rule. For this example, skip yield
# indices and volatility indices, then keep only symbols with usable local
# Yahoo OHLC cache.
