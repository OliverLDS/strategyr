...
rsi_mining_res <- strategyr::mine_strategy_asset_years(
...
print(rsi_mining_res$seed_params[, .(
  seed_asset,
  rank,
  n,
  oversold,
...
print(rsi_mining_res$candidate_params)

asset_year_res <- rsi_mining_res$asset_year_results
