...
utils::globalVariables(c(
  ...
  "avg_score_decay", "avg_total_return", "availability", "available_assets", "breadth_ad", "breadth_adl",
  ...
  "n_windows", "param_id", "positive_return_rate", "prev_close", "price", "rebalance_eligible", "realized_weight",
  "prior_high", "prior_low", "px_1", "px_2", "px_3", "r",
  "raw_delta_units", "raw_target_units", "rebalance_due", "rho", "rho_pos", "sigma",
  "signal_date", "stale_valuation",
  "target_notional", "target_units", "target_weight", "theta", "theta_pos", "turnover", "unavailable_assets",
  "time_to_expiry",
